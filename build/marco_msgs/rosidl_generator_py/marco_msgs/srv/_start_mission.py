...
class Metaclass_StartMission(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from marco_msgs.srv import _start_mission
...
class StartMission(metaclass=Metaclass_StartMission):
    from marco_msgs.srv._start_mission import StartMission_Request as Request
    from marco_msgs.srv._start_mission import StartMission_Response as Response

...
#include "marco_msgs/msg/detail/lane_offset__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // camera_frame
#include "rosidl_runtime_c/string_functions.h"  // camera_frame
...
using _LaneOffset__ros_msg_type = marco_msgs__msg__LaneOffset;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LaneOffset__ros_msg_type * ros_message = static_cast<const _LaneOffset__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LaneOffset__ros_msg_type * ros_message = static_cast<_LaneOffset__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_marco_msgs__msg__LaneOffset(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LaneOffset__ros_msg_type * ros_message = static_cast<const _LaneOffset__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _LaneOffset__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_marco_msgs__msg__LaneOffset(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_marco_msgs
size_t max_serialized_size_marco_msgs__msg__LaneOffset(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = marco_msgs__msg__LaneOffset;
    is_plain =
      (
...
static size_t _LaneOffset__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_marco_msgs__msg__LaneOffset(
...
static message_type_support_callbacks_t __callbacks_LaneOffset = {
  "marco_msgs::msg",
  "LaneOffset",
...
static rosidl_message_type_support_t _LaneOffset__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LaneOffset,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, marco_msgs, msg, LaneOffset)() {
  return &_LaneOffset__type_support;
}

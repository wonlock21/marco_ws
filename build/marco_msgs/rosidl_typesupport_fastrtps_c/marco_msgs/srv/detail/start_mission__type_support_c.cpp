...
#include "marco_msgs/srv/detail/start_mission__rosidl_typesupport_fastrtps_c.h"
...
using _StartMission_Request__ros_msg_type = marco_msgs__srv__StartMission_Request;
...
size_t get_serialized_size_marco_msgs__srv__StartMission_Request(
  const void * untyped_ros_message,
...
static uint32_t _StartMission_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_marco_msgs__srv__StartMission_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_marco_msgs
size_t max_serialized_size_marco_msgs__srv__StartMission_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = marco_msgs__srv__StartMission_Request;
    is_plain =
      (
...
static size_t _StartMission_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_marco_msgs__srv__StartMission_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, marco_msgs, srv, StartMission_Request)() {
...
using _StartMission_Response__ros_msg_type = marco_msgs__srv__StartMission_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_marco_msgs
size_t get_serialized_size_marco_msgs__srv__StartMission_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StartMission_Response__ros_msg_type * ros_message = static_cast<const _StartMission_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_marco_msgs__srv__StartMission_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_marco_msgs
size_t max_serialized_size_marco_msgs__srv__StartMission_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = marco_msgs__srv__StartMission_Response;
    is_plain =
      (
...
static size_t _StartMission_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_marco_msgs__srv__StartMission_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, marco_msgs, srv, StartMission_Response)() {
...
// already included above
// #include "marco_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "marco_msgs/srv/start_mission.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, marco_msgs, srv, StartMission)() {

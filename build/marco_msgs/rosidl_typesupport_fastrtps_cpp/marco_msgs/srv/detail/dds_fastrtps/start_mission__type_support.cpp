...
#include "marco_msgs/srv/detail/start_mission__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const marco_msgs::srv::StartMission_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  marco_msgs::srv::StartMission_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = marco_msgs::srv::StartMission_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const marco_msgs::srv::StartMission_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<marco_msgs::srv::StartMission_Request *>(
    untyped_ros_message);
...
{
  return &marco_msgs::srv::typesupport_fastrtps_cpp::_StartMission_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, marco_msgs, srv, StartMission_Request)() {
  return &marco_msgs::srv::typesupport_fastrtps_cpp::_StartMission_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_marco_msgs
cdr_serialize(
  const marco_msgs::srv::StartMission_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  marco_msgs::srv::StartMission_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = marco_msgs::srv::StartMission_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const marco_msgs::srv::StartMission_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<marco_msgs::srv::StartMission_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &marco_msgs::srv::typesupport_fastrtps_cpp::_StartMission_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, marco_msgs, srv, StartMission_Response)() {
  return &marco_msgs::srv::typesupport_fastrtps_cpp::_StartMission_Response__handle;
}
...
{
  return &marco_msgs::srv::typesupport_fastrtps_cpp::_StartMission__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, marco_msgs, srv, StartMission)() {
  return &marco_msgs::srv::typesupport_fastrtps_cpp::_StartMission__handle;
}

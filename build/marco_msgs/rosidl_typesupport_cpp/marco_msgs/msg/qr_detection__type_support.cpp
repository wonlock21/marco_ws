...
static const _QrDetection_type_support_symbol_names_t _QrDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, marco_msgs, msg, QrDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, marco_msgs, msg, QrDetection)),
  }
};
...
{
  return &::marco_msgs::msg::rosidl_typesupport_cpp::QrDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, marco_msgs, msg, QrDetection)() {
  return get_message_type_support_handle<marco_msgs::msg::QrDetection>();
}

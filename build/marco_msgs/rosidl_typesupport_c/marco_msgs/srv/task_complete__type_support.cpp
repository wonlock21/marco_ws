...
static const _TaskComplete_Request_type_support_symbol_names_t _TaskComplete_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, marco_msgs, srv, TaskComplete_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, marco_msgs, srv, TaskComplete_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, marco_msgs, srv, TaskComplete_Request)() {
  return &::marco_msgs::srv::rosidl_typesupport_c::TaskComplete_Request_message_type_support_handle;
}
...
static const _TaskComplete_Response_type_support_symbol_names_t _TaskComplete_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, marco_msgs, srv, TaskComplete_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, marco_msgs, srv, TaskComplete_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, marco_msgs, srv, TaskComplete_Response)() {
  return &::marco_msgs::srv::rosidl_typesupport_c::TaskComplete_Response_message_type_support_handle;
}
...
static const _TaskComplete_type_support_symbol_names_t _TaskComplete_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, marco_msgs, srv, TaskComplete)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, marco_msgs, srv, TaskComplete)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, marco_msgs, srv, TaskComplete)() {
  return &::marco_msgs::srv::rosidl_typesupport_c::TaskComplete_service_type_support_handle;
}

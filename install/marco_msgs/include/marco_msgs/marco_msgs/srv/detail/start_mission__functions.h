...
#ifndef MARCO_MSGS__SRV__DETAIL__START_MISSION__FUNCTIONS_H_
#define MARCO_MSGS__SRV__DETAIL__START_MISSION__FUNCTIONS_H_
 ...
 * calls
 * marco_msgs__srv__StartMission_Request__init().
...
/**
 * It calls
 * marco_msgs__srv__StartMission_Request__fini()
 ...
 * marco_msgs__srv__StartMission_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * marco_msgs__srv__StartMission_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * marco_msgs__srv__StartMission_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_marco_msgs
...
/**
 * It calls
 * marco_msgs__srv__StartMission_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_marco_msgs
...
/**
 * It allocates the memory for the array and calls
 * marco_msgs__srv__StartMission_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_marco_msgs
...
/**
 * It calls
 * marco_msgs__srv__StartMission_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MARCO_MSGS__SRV__DETAIL__START_MISSION__FUNCTIONS_H_

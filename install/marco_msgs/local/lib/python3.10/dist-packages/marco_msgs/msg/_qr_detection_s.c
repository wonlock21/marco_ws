...
bool marco_msgs__msg__qr_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("marco_msgs.msg._qr_detection.QrDetection", full_classname_dest, 40) == 0);
  }
  marco_msgs__msg__QrDetection * ros_message = _ros_message;
  {  // header
  ...
  {  // pose_in_camera
    PyObject * field = PyObject_GetAttrString(_pymsg, "pose_in_camera");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__pose2_d__convert_from_py(field, &ros_message->pose_in_camera)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * marco_msgs__msg__qr_detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("marco_msgs.msg._qr_detection");
  ...
  {  // pose_in_camera
    PyObject * field = NULL;
    field = geometry_msgs__msg__pose2_d__convert_to_py(&ros_message->pose_in_camera);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "pose_in_camera", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
